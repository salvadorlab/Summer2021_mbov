...
sub_data <- subset(mbov_rf.results,class == "Population Cluster")
  ...
  geom_point() +
    ...
    ggtitle("Population Cluster") + 
       ...
       annotate(geom = "text", x = 14.7, y = 15.010953, label = "rpfA", hjust = "left") +
        annotate(geom = "text", x = 16, y = 5.670926, label = "rpfA", hjust = "left") +
       annotate(geom = "text", x = 17.8, y = 24.702927, label = "pks12", hjust = "left") +
       annotate(geom = "text", x = 16, y = 12.307589, label = "pks12", hjust = "left") +
       annotate(geom = "text", x = 16.5, y = 13.671872, label = "Mb2189c", hjust = "left") +
       annotate(geom = "text", x = 28.6, y = 31.784458, label = "Mb3510c", hjust = "left") +
     xlim(c(-10,35))
```
...
sub_data <- subset(mbov_rf.results,class == "Species")
  ...
  geom_point() +
    ...
    ggtitle("Species") + 
     ...
     annotate(geom = "text", x = 14.9, y = 3.685742, label = "rpfA", hjust = "left") + 
     xlim(c(-10,28))
...
sub_data <- subset(mbov_rf.results,class == "Country")
  ...
  geom_point() +
    ...
    scale_color_manual(values = c("gray","black")) +
    ggtitle("Country") + 
     annotate(geom = "text", x = 13.8, y = 13.964651, label = "Mb0403", hjust = "left") +
    ...
    annotate(geom = "text", x = 11.6, y = 2, label = "rpfA", hjust = "left") + 
      ...
      annotate(geom = "text", x = 12.9, y = 20.689603, label = "pks12", hjust = "right") + 
     xlim(c(-10,35))
```
